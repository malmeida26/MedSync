...
class CadastrarProdutos : ComponentActivity() {
...
// botao
        ...
        // toast's
        CustomToast(show = showToast, message = "Produto Cadastrado", texto = Blue10, icone = Blue10, backgroundColor = GreenToast, tipo = true)
...
@Composable
fun CustomToast(show: Boolean, message: String, texto: Color, icone: Color, backgroundColor: Color, tipo: Boolean) {
    AnimatedVisibility(
        visible = show,
        ...
        Box(
            ...
            Row(
                ...
                Icon(
                    if(tipo) Icons.Default.Check else Icons.Default.Close,
